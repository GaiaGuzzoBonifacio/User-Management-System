...
class UserValidation {
    ...
    public const PSW_ERROR_REQUIRED_MSG = 'La password è obbligatoria';
    public const PSW_ERROR_NONE_MSG = 'Il formato della password è corretto';
    ...
    private function validateBirthday():?ValidationResult
    {
        ...
        if(empty($date)){
            // la mail non è obbligatoria quindi se è vuota restituisco un messaggio positivo
    ...
    private function validatePassword():?ValidationResult
    {
        ...
        if(empty($password)){
            $validationResult = new ValidationResult(self::PSW_ERROR_REQUIRED_MSG,false,$password);
        } else {
            $validationResult = new ValidationResult(self::PSW_ERROR_NONE_MSG,true,$password);
        };
        return $validationResult;
    }
